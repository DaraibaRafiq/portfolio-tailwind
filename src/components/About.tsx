...
const About = () => {
  return (
    <div id="about" className="container pt-32">
      ...
      <p className="text-white pt-4 text-3xl mt-9" data-aos="zoom-in-up">
      I am a student at GIAIC,pursuing a course in Artificial Intelligence, Web 3.0, & Metaverse.
      Passionate about technology and constantly learning new skills to stay up-to-date to the latest.
      </p>
    </div>
  )
}
